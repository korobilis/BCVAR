function [dates_new,Y_sim,A_OLS,SIGMA_OLS] = simulate_DGP_actual(dates,X,T,p,t_beg,t_end)
...
disp('VAR has missing values for the following dates - drop them before estimation:');
...
[Y_sim,~] = simvardgp_DP(T,size(Y_nanfree,2),p,A_OLS,PSI_OLS,1);
