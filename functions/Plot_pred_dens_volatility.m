function Plot_pred_dens_volatility(VAR_size,h_list)
...
for this_h=h_list
    ...
    for i=1:length(series_to_eval)
        ...
        if i==1
            legend([h1,h2,h3,h4,h5,h6],'DFM','FAVAR','BVAR','BCVAR','BCVAR_c','BCVAR_{tvp}','Location','SouthWest','Orientation','Horizontal');
            legend('boxoff');
        end
    ...
    % Save figure
    f_id_tmp = [this_out,'Figure_std_dev_',VAR_size,'_h_',num2str(this_h)];
