function Plot_CUM_PL(VAR_size,h_list,date_start,date_end)
...
file_id_all = [VAR_size,'_CUM_PL_figures.pdf'];
...
%BCTRVAR, with cov compression, tvp-sv
...
for this_h=h_list
    ...
    for i=1:length(series_to_eval)
        ...
        plot(dates(T_beg+this_h:T_end-h+this_h),cumsum(log(PL4(this_start:this_end,this_h,i)) - log(PL0(this_start:this_end,this_h,i))),'linewidth',2)
        hold on;
        plot(dates(T_beg+this_h:T_end-h+this_h),cumsum(log(PL5(this_start:this_end,this_h,i)) - log(PL0(this_start:this_end,this_h,i))),'linewidth',2)
        plot(dates(T_beg+this_h:T_end-h+this_h),cumsum(log(PL3(this_start:this_end,this_h,i)) - log(PL0(this_start:this_end,this_h,i))),'linewidth',2)
        plot(dates(T_beg+this_h:T_end-h+this_h),cumsum(log(PL2_0(this_start:this_end,this_h,i)) - log(PL0(this_start:this_end,this_h,i))),'linewidth',2)
        plot(dates(T_beg+this_h:T_end-h+this_h),cumsum(log(PL2_1(this_start:this_end,this_h,i)) - log(PL0(this_start:this_end,this_h,i))),'linewidth',2)
        plot(dates(T_beg+this_h:T_end-h+this_h),cumsum(log(PL2_3(this_start:this_end,this_h,i)) - log(PL0(this_start:this_end,this_h,i))),'linewidth',2)
    ...
    % Save figure
    f_id_tmp = [this_out,'Figure ',VAR_size,' CUM LS h=',num2str(this_h),' (',datestr(date_start,'yyyy'),'--',datestr(date_end,'yyyy'),')'];
