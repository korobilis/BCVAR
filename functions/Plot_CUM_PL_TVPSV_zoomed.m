function Plot_CUM_PL_TVPSV_zoomed(VAR_size_list,date_start,date_end)
...
% Save figure
f_id_tmp = [this_out,'Figure_BCVAR_TVPSV_PL_zoomed_in',datestr(date_start,'yyyy'),'_',datestr(date_end,'yyyy')];
