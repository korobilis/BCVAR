function Plot_CUM_SSE_TVPSV_zoomed(VAR_size_list,date_start,date_end)
...
% Save figure
f_id_tmp = [this_out,'Figure_BCVAR_TVPSV_SSE_zoomed_in_',datestr(date_start,'yyyy'),'_',datestr(date_end,'yyyy')];
